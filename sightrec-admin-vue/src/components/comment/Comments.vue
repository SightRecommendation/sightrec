<template>
  <div class="comments">
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="输入评论内容" v-model="queryInfo.query" clearable @clear="getCommentList">
      ...
      <el-table :data="commentList" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template slot-scope="scope">
            ...
            <!-- 删除按钮 -->
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeCommentById(scope.row.id)">
            </el-button>
          </template>
        </el-table-column>
      </el-table>
