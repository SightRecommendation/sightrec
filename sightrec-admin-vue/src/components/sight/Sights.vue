<template>
  <div class="comments">
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="输入景点名称" v-model="queryInfo.query" clearable @clear="getSightList">
            <el-button slot="append" icon="el-icon-search" @click="searchSights"></el-button>
          </el-input>
        </el-col>
        <!-- <el-col :span="4">
      ...
      <el-table :data="sightList" border stripe>
        ...
        <el-table-column label="操作" width="120px">
          <template slot-scope="scope">
            ...
            <!-- 删除按钮 -->
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeSightById(scope.row.id)">
            </el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
        ...
        layout="total, sizes, prev, pager, next, jumper" :total="sightNum">
      </el-pagination>
    </el-card>

    <!-- 修改景点对话框 -->
    <el-dialog title="修改景点" :visible.sync="editDialogVisible" width="70%" @close="editDialogClosed">
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="80px">
        ...
        <el-form-item label="介绍" prop="introduction">
          <el-input type="textarea" autosize v-model="editForm.introduction"></el-input>
        </el-form-item>
      </el-form>
